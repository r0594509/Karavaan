            ...
            >
                <View style={{ marginTop: 22, flex: 1 }}>
                    <TextInput
                        id={'tripName'}
                        title={'trip name'}
                        titleInvalid={'trip name is not valid'}
                        placeholder={'The trip name should contain at least 5 characters'}
                        onChangeText={this.onChangeText}
                        isValid={formIsValid || this.isTripNameValid}
                    />
                    <TextInput
                        id={'tripDesc'}
                        title={'trip description'}
                        titleInvalid={'trip description is not valid'}
                        placeholder={'Please enter a description for your trip'}
                        onChangeText={this.onChangeText}
                        isValid={formIsValid || this.isTripDescValid}
                    />
                    <View style={{ width: 400, marginLeft: 8 }}>
                        <Dropdown
                            ...
                            onChangeText={(tripCurrency) => this.onChangeText('tripCurrency', tripCurrency)}
                            containerStyle={{ paddingRight: 15 }}
                            baseColor={(formIsValid || this.isCurrencyValid()) ? 'black' : 'red'}
                            dropdownPosition={1}
                        />
                    </View>
                    <View style={{ flex: 1}}>
                ...
                <Button title={'Save'} onPress={this.saveTrip} />
            </Modal>
